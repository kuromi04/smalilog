"""Guía completa de smalilog: instrumentación de aplicaciones Android con logging remoto."""

# Introducción

`smalilog` es una herramienta para instrumentar aplicaciones Android con logging
remoto mediante inyección de código Smali y un servidor HTTP. Permite:

- Capturar logs desde aplicaciones Android en tiempo real.
- Visualizar los logs en un dashboard web o en terminal.
- Filtrar logs por nivel, tag y origen.
- Soportar comunicación segura (TLS) y no segura (WebSocket).
